...
from autosprint.app.cli import parse_cli_args
...
def test_claude_only_flag_expands_to_council_opus(monkeypatch: pytest.MonkeyPatch, initialised_target_repo: Path) -> None:
...
def test_copilot_only_flag_expands_to_council_gpt55(monkeypatch: pytest.MonkeyPatch, initialised_target_repo: Path) -> None:
...
def test_claude_only_and_copilot_only_are_mutually_exclusive(monkeypatch: pytest.MonkeyPatch, initialised_target_repo: Path) -> None:
...
def test_explicit_team_wins_over_claude_only(monkeypatch: pytest.MonkeyPatch, initialised_target_repo: Path) -> None:
